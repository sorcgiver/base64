...
//    unsigned char GetBase64Code(const unsigned char symbol);
    void* base64_encode(const unsigned char* data_in, const unsigned int data_in_size, unsigned int *data_out_size); // encrypt in base64 binary
    void* base64_decode(const unsigned char* data_in, const unsigned int data_in_size, unsigned int *data_out_size); // decrypt in base64 binary
